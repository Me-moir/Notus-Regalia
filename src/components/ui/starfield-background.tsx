...
// Inlined cn utility — no @/lib/utils dependency needed
...
export interface StarfieldBackgroundProps {
  ...
  /** Enable twinkling */
  twinkle?: boolean
  /** Position mode — use 'fixed' for fullscreen backgrounds, 'absolute' to scope to a parent container */
...
export function StarfieldBackground({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "inset-0 overflow-hidden bg-[#0a0a0f]",
